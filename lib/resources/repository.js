...
Repository.prototype.deleteTag = function (params, callback) {
  params.type = 'tags';
  console.log("gitlab delete tag has path:", this.path);
  this.client.request('DELETE', this.path + '/:tag_name', params, callback);
};
